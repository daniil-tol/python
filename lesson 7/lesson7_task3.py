...
class Cell:
    ...
    def __add__(self, other): # Сложение. Объединение двух клеток
        return Cell(self.quantity + other.quantity)

    def __sub__(self, other):
        return self.quantity - other.quantity if (self.quantity - other.quantity) > 0 else print('Отрицательно!.Операция вычитания невозможна')
